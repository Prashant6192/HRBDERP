...
### Phases A–H — The factory, end to end, across facilities
...
| Opening stock as immutable ledger postings; per-facility switch; Super Admin old-stock screen with sheet import, QC auto-passed                                                                                                                                                                 | Built |
...
| Third-party / contract manufacturing inside the same workflow: client master, product and formula ownership, client-supplied material segregated by owner, third-party plans and orders, job costing, material reconciliation, artwork approvals, client QC specs, dashboard section (issue #6) | Built |
...
| Online orders: combos and pick lists, filterable main screen, cancel by scan, returns with damaged store and claims       | Built |
...
- Excel import for masters, validated before commit (opening stock is done); exports
...
| **Only the formulation and opening-stock imports exist** | Masters and price imports are not yet built                                                                            | Phase 10. Validate fully before committing anything, as the formulation import does                                                              |
